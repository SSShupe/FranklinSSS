...
featured_image = "/assets/OldStanfordHosp.jpg"
...
I'm finally starting the trial. To get updates go to my [existing site](https://ssshupe.com), click on a post, and subscribe to the site. Any new post will get sent to you automatically. Or check out that site or my new site from time to time.
...
Not only did I/Claude make significant changes to the site, but we also implemented code that automatically sends any new post to my [existing site](https://ssshupe.com), where I can review it and publish it, avoiding the pain of copying and pasting. That process was painful and I still don't trust it completely, but we'll see how it performs.